...
<body class="body">
	...
	<form:form method="get" action="generateReport" modelAttribute="report">
	<table width="100%">
		<tr>
			<td></td>
			<td></td>
			<td align="right"><a href="pvreport">Show Publication Report</a></td>
		</tr>
		<tr>
		...
		<tr><td colspan="3"><table border="1">
			...
			<tr><td colspan="5">&nbsp;</td><td><a href="generateReport?page=previous">Previous</a></td><td><b><p>${pageText}</p></b></td><td><a href="generateReport?page=next">Next</a></td></tr>
		 </table></td></tr>
	</c:if>
	<tr><td>&nbsp;</td></tr>
	<!-- Display Publication 
